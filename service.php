...
<!-- Menu -->
<div id="menu" style="background-color:#212129;" class="w3-container  w3-xxlarge w3-padding-64">
<h1 class="w3-center w3-jumbo w3-padding-32" style="color:white;" >THE MENU</h1>
...
$resultr=mysqli_query($conn,$qryr);
	echo'<h1 id="pasta" class="w3-center w3-jumbo w3-padding-32" style="color:white;">'.$v["Type_Item"].'</h1><div id="pizza" class="w3-container w3-white w3-padding-32">';
...
echo '<h1><b>'.$valr["Name_Item"].'</b> <span class="w3-right"><img width="450px" height="290px" src='.$valr["photo"].'></span></h1>
<p class="w3-text-grey">'.$valr["Desc_Item"].'</p>
<p class="w3-text-grey"><b>'.$valr["Price_Item"].'$</b></p><form method="POST">'.$output.'</form><br>
<hr>';
